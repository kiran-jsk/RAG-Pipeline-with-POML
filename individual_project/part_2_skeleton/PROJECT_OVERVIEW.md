...
2. **Routing**: A POML prompt classifies the question based on what programming language it is refering to.
...
- Short PDF write-up explaining what you did and any takeaways you have relating to chunking, retrieval, model selection, prompting techniques, or POML.
